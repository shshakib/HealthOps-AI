...
Generated: 2026-09-21T19:31:10.166368+00:00
...
|---|---|
| Answer cases | 23/24 |
| tool selection | 23/24 |
| criterion statuses | 24/24 |
| topic | 23/24 |
| citation selection | 23/24 |
| evidence binding | 24/24 |
| no model fallback | 23/24 |
...
| Fallback answers | 1/24 |
| P95 assistant time (excludes root trace export) | 3920.56 ms |
| Provider cost | $0.02349300 (estimate) |
| Model calls | 56 |
...
| fresh-02 | PASS | model_assisted | criterion |
...
| fresh-19 | PASS | model_assisted | workflow |
